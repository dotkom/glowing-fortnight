...
export const API_LEADERBOARD_URL = process.env.API_LEADERBOARD_URL || `http://localhost:3000/api/sheet`;
export const API_EVENTS_URL = `${API_BASE_URL}/api/v1/splash-events/?start_time__gte=${new Date().getFullYear()}-06-01`;
