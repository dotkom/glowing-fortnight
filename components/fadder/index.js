    ...
    <div id="fadder">
      <div className="component fadder-content">
        <div className="fadder-description">
          ...
          <p>Fadderukene starter den 14. august for både bachelor og master.</p>
          <p>
            For praktisk info rundt fadderukene se{' '}
            <a href="https://old.online.ntnu.no/wiki/online/fadderukene/2023-/" target="_blank" rel="noreferrer">
              her
            </a>
            .
          </p>
