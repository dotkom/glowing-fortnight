...
const Warning = () => {
  return (
    <div id="warning" className="component">
      ...
      <p>
        Online har et eget uavhengig organ for varslinssaker som kan hjelpe under fadderukene. Vi ønsker at alle skal ha
        det bra og føle seg trygge under fadderukene. Derfor håper vi at du tar kontakt dersom du har opplevd noe
        ubehagelig. Ser du at noen andre opplever noe ubehagelig er det viktig å huske på at du også har et ansvar for å
      ...
      <p>Om situasjonen tilsier at du trenger å snakke med noen umiddelbart kan du alltid ringe oss på 966 46 705.</p>
      <a
