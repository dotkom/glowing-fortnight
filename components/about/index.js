const About = () => {
  return (
    <header id="about" className="component">
      ...
      <p>Vi har samlet litt info for nye informatikere med spørsmål, ta en titt på <a href="https://online.ntnu.no/wiki/online/ny-paa-informatikk/">wikien</a> for å sjekke den ut!</p>
      <p>Ny på master? Se <a href="https://online.ntnu.no/events/708/it-ekskursjonen-2019/">her</a> for viktig info om IT-ekskursjonen, OBS kort frist! </p>
