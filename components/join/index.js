const Join = () => {
  return (
    <div id="join" className="component">
      ...
      <p>Alle informatikere har rett til å bli medlem av linjeforeningen. Gå videre til <a href="https://online.ntnu.no/">hovedsiden</a> for å opprette din brukerkonto i Online sine systemer.</p>
      ...
      <p>Søknadsfrist for komiteopptak er 28. august kl. 23:59. Søknader rettes til <a href="mailto:opptak@online.ntnu.no">opptak@online.ntnu.no</a></p>
    </div>
  );
};
