...
const Join = ({ applicationDeadline }) => {
  ...
  return (
    <div id="join" className="component">
      ...
      <p>
        Online er linjeforeningen for alle informatikere. Gå videre til <a href="https://online.ntnu.no/">hovedsiden</a>{' '}
        for å lage brukerkonto og bli medlem.
      </p>
      <p>
        Lurer du på hva som skjer i linjeforeningen eller hvem du skal kontakte for å få booke kontoret? En kjapp
        innføring i ditt liv i Online er å finne på{' '}
        <a
      ...
      <p>
        Har du lyst til å gjøre studietiden til informatikere enda bedre? Som komitemedlem i Online blir du del av en
